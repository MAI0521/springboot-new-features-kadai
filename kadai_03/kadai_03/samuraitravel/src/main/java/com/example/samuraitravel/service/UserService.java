...
public class UserService {
     ...
     public Page<User> searchUsers(String nameKeyword, String furiganaKeyword, int page, int size) {
         return userRepository.findByNameLikeOrFuriganaLike(nameKeyword, furiganaKeyword, PageRequest.of(page, size));
     }
}
